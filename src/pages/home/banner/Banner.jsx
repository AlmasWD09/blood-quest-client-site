    ...
    return (
        <div className="h-[300px] md:h-[600px] bg-hero-bg bg-cover bg-center w-full flex items-center">
           ...
           <div className="md:max-w-[40%] bg-white rounded p-2 md:p-8 space-y-3 md:space-y-6">
                ...
                className="px-2 md:px-5 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-secondery rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Search donars</button>
                </div>
            </div>
           </Container>
        </div>

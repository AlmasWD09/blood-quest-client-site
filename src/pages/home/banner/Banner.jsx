                ...
                <div className="md:max-w-[80%] lg:max-w-[40%] md:mx-auto lg:mx-0 bg-white rounded p-4 lg:p-8 space-y-3 md:space-y-6">
                    ...
                    <div className="flex gap-4 md:gap-6 py-3">
                        <button
                            ...
                            className="px-2 md:px-5 py-2.5 leading-5 text-white font-semibold transition-colors duration-300 transform bg-primary rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Join as a donor</button>

                        <button onClick={handleDonars}
                            className="before:block before:absolute before:-inset-1 before:-skew-y-6 before:bg-secondery relative inline-block px-2 md:px-5 py-2.5 leading-5 before:rounded-md">

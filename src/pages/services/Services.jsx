            ...
            <Container>
                <div className="my-8">
                    <div className="max-w-md mx-auto text-center pb-8">
                        <h1 className="text-center text-4xl lg:text-5xl font-bold  text-secondery">Our Services</h1>
                        <p className="text-gray-500">Connects donors with recipients, handles donation requests, tracks donations, and raises health awareness</p>
                    </div>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {/* Item 1 */}
                        <div className="flex flex-col justify-center items-center bg-gray-50 px-10 py-8 lg:py-20 space-y-2 md:order-2 lg:order-1">
                        ...
                        {/* Item 2 */}
                        <div className=" flex flex-col justify-center items-center bg-primaryGray px-10 py-8 md:py-10 lg:py-20 lg:space-y-2 lg:col-span-2 md:space-y-2 md:col-span-2 md:order-1 lg:order-2">
                        ...
                        {/* Item 3 */}
                        <div className="flex flex-col justify-center items-center bg-gray-50 px-10 py-8 lg:py-20 space-y-2 md:order-2 lg:order-3">
                        ...
                        {/* Item 4 */}
                        <div className="flex flex-col justify-center items-center bg-gray-50 px-10 py-8 lg:py-20 space-y-2 md:order-2 lg:order-4">
                            <img src={service04} alt="24/7 Security Guards" />
                            <h2 className="text-xl md:text-3xl text-gray-600 font-semibold text-center">24/7 Security Guards</h2>
                        ...
                        {/* Item 5 */}
                        <div className="flex flex-col justify-center items-center bg-gray-50 px-10 py-8 lg:py-20 space-y-2 md:order-2 lg:order-5">
                            <img src={service05} alt="Award-Winning Support" />
                            <h2 className="text-xl md:text-3xl text-gray-600 font-semibold text-center">Award-Winning Support</h2>

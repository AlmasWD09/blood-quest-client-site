            ...
            <div className="relative  flex justify-between items-center  px-6 py-6">
                ...
                <div className=" w-[60%] lg:flex lg:justify-center lg:items-center hidden">
                    <div>
                        ...
                        <NavLink to='/dashboard' className="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">
                            Dashboard
                        </NavLink>
                    </div>
                </div>
